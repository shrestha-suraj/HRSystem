	...
	public static void main(String[] args) {
		...
		if(choice==1) {
			...
			do {
				...
				switch(option){
					case 1: System.out.print("Type of employee:\n1) Contarctor\n2) Full-Time\nType one choice: ");
							int typeChoice=keyboard.nextInt();
							System.out.println("Enter employee id: ");
							int empId=keyboard.nextInt();
							System.out.print("Enter employee full name: ");
							String[] empName=keyboard.nextLine().split(" ");
							System.out.print("How many roles you want to register for the employee? Enter number: ");
							...
							System.out.print("Enter address, Format: ZipCode,Country,State,City,StreetAddress,AddressLine2 :  ");
							String[] addressToken=keyboard.nextLine().split(",");
							Address empAddress=new Address(addressToken[0],addressToken[1],addressToken[2],addressToken[3],addressToken[4],addressToken[5]);
							//Creating a complete employee
							Employee employee=null;
							if(typeChoice==1) {
								System.out.println("Enter contractor information i.e. StartDate EndDate and HourlySalary, Format: MM/DD/YYYY MM/DD/YYYY Salary");
								String[] contractorToken=keyboard.nextLine().split(" ");
								employee=new Contractor(new DateTime(contractorToken[0]),new DateTime(contractorToken[1]),Float.parseFloat(contractorToken[2]),new Employee(empId,empName[0],empName[1]));
							}else {
								System.out.println("Enter FullTime employee information i.e. StartDate SalaryPerYear and BonusPerYear, Format: MM/DD/YYYY Salary Bonus");
								String[] fulltimeToken=keyboard.nextLine().split(" ");
								employee=new FullTime(new DateTime(fulltimeToken[0]),Float.parseFloat(fulltimeToken[1]),Float.parseFloat(fulltimeToken[2]),new Employee(empId,empName[0],empName[1]));
							}
							...
							break;
					case 2: System.out.print("Enter employeeId in given format: ");
							try {
							...
							break;
					case 3: System.out.print("Enter Employee FullName: ");
							...
							if(result.size()!=0) {
								for(Employee each:result) {
									System.out.println("Id: "+each.getId()+", Name: "+each.getFirstName()+" "+each.getLastName());
								}
							}else {
